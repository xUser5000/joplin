...
const commands = [require('./commands/newNote'), require('./commands/newTodo'), require('./commands/toggleSidebar'), require('./commands/toggleNoteList'), require('./commands/newNotebook')];
...
class MainScreenComponent extends React.Component {
	...
	renderNotification(theme, styles) {
		...
		if (this.props.hasDisabledSyncItems) {
			msg = React.createElement(
				...
				React.createElement(
					'a',
					{ href: '#', onClick: () => onViewStatusScreen() },
					_('View them now')
				)
			);
			...
			msg = React.createElement(
				...
				React.createElement(
					'a',
					{ href: '#', onClick: () => onViewEncryptionConfigScreen() },
					_('Set the password')
				)
			);
	...
	render() {
		...
		return React.createElement(
			...
			React.createElement(VerticalResizer, { style: styles.verticalResizerSidebar, onDrag: this.sidebar_onDrag }),
			React.createElement(NoteList, { style: styles.noteList }),
			React.createElement(VerticalResizer, { style: styles.verticalResizerNotelist, onDrag: this.noteList_onDrag }),
			React.createElement(NoteEditor, { bodyEditor: bodyEditor, style: styles.noteText }),
			pluginDialog
		);
	}
}
